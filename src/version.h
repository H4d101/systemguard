...
#define APP_ID        "systemguard"
#define APP_NAME      "systemguard"
#define APP_DESC      "systemguard"
#define APP_VERSION   "6.24.0"
#define APP_DOMAIN    "systemguard"
#define APP_SITE      "systemguard"
#define APP_COPYRIGHT "Copyright (C) 2016-2025 systemguard"
